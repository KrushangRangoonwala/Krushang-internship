...
const TryByMeState = () => {
    ...
    async function editState(values) {
        let payload = {
            countryMasterId: values.country_id,
            name: values.states,
        }
        try {
        ...
        <>
            ...
            <div className='container2'>
                ...
                <form onSubmit={formik.handleSubmit}>
                    ...
                    <input name='search' id='search' type='text' placeholder='search your country' onChange={(e) => {
                    ...
                    <input name='states' id='states' type='text' placeholder='Enter new State' onChange={formik.handleChange}
                        onBlur={formik.handleBlur}
                    ...
                    <br /><br />
                    <button type="submit">{toggle ? 'Edit State' : 'Add States'}</button>
                </form>
            ...
            {(country_name.length > 0) ?
                        ...
                        <tbody>
                            ...
                            {states.map((value, index) =>
                                ...
                                <tr key={index}>
                                    ...
                                    <th><button onClick={() => navigate(`/state/${value.id}`)}>View</button></th>

                                    <th><button onClick={() => {
                                        setToggle(true);
                                        formik.setValues({
                                            search: country_name,
                                            country_id: value.countryMasterId,
                                            states: value.name,
                                            state_id: value.id,
                                        })
                                    }}>Edit</button></th>
                ...
                <div style={{ margin: ' 0vw 20vw' }}>
                    <h3> Total States of All Country</h3>
                    <table className='table table-striped' >
                        <tbody>
                            <tr>
                                <th>Sr no.</th>
                                ...
                                <tr key={index}>
                                    ...
                                    <th><button onClick={() => {
                                        ...
                                        formik.setValues({
                                            ...
                                            country_id: value.country_master.id,
                                            states: value.name,
                                            state_id: value.id,
                                        })
                                    }}>Edit</button></th>
