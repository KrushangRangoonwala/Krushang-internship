...
// let fieldsetFirstElement = document.getElementById('completedTasks').firstElementChild;
...
//     let ulNextElement = fieldsetFirstElement.nextElementSibling;
...
// let taskKeyWords = '/' + task + '/';
// console.log(taskKeyWords);
let taskKeyWords = new RegExp(task,'i')
console.log((str).search(taskKeyWords));
