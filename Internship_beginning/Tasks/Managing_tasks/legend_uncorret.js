...
function updateLocalStorage() {
    ...
    if (completedTasksFirstElement) {
        ...
        if (completedTasksFirstElement.tagName == 'LEGEND') {
            var ulNextElement = completedTasksFirstElement.nextElementSibling;
            if (ulNextElement) {
                let task_id = ulNextElement.id;
                console.log("1");
        ...
        while (ulNextElement) {
            ...
            // addDataToLocalStorage(task_id, localStorageArray, true);
            // ulNextElement = ulNextElement.nextElementSibling;
            if (ulNextElement.tagName == 'LEGEND') {
                var ulNextElement = completedTasksFirstElement.nextElementSibling;
                if (ulNextElement) {
                    let task_id = ulNextElement.id;
                    addDataToLocalStorage(task_id, localStorageArray, true);
